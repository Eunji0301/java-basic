...
//         default : 같은 폴더 안에 있는 객체끼리 사용 가능
        ...
        c1.divide();
        // c1.num2 = 0; // 여기서 0을 넣은 게 문제의 원인. 누구나 접근해서 바꿔버릴 수 있음.
//        private을 이용해 Calculator의 데이터를 보호할 수 있다.
        ...
        // 객체변수는 객체 내의 모든 메서드에 영향을 주므로 외부의 접근 일반적으로 private으로 막는다.
